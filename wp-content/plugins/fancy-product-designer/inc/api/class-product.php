	...
	class FPD_Product {
		...
		public function to_JSON() {
			...
			foreach($views as $view) {
				...
				$view_options_json = $view_count == 0 ? $first_view_options : $fancy_view->get_options();
				//merge product options into first view options
				$options_json = array_merge((array) $product_options, (array) $view_options_json);
				$options_json = FPD_View::setup_options($options_json);
				...
				if( isset($view_options_json['mask']) )
					$view_array['mask'] = $view_options_json['mask'];
