                                    ...
                                    <div class="container-fluid">
                                        <div class="navbar-header">
                                            ...
                                            <h1 class="site-title visible-xs hidden-md hidden-sm" >
                                                <a href="<?php echo esc_url(home_url('/')); ?>" rel="home"><img class="img-responsive navbar-brand" src="http://47.74.226.159/cpb_uat/wp-content/uploads/2017/09/cropped-customprintboxlogoFINAL_black-1.png" alt="theme-logo" /></a>
                                            </h1> 
                                            <?php
                                            $description = esc_attr(get_bloginfo('description', 'display'));
                                            if ($description || is_customize_preview()) {
    ...
    function somalite_header_shop_style() {
                                    ...
                                    if (somalite_is_woocommerce_activated()) {
                                        ...
                                        <span class="top-menu-links">
                                            ...
                                            if (is_user_logged_in()) {
                                                ...
                                                ?>
                                                <a href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>"><?php _e('Login', 'somalite'); ?> <i class="fa fa-sign-in"></i></a> |         			
                                                <a href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>"><?php _e('Register', 'somalite'); ?> <i class="fa fa-user"></i></a>        			
                                                <?php
                                            }
                                            ?>				              					
        ...
        if ($description || is_customize_preview()) {
            ?>
                                        ...
                                        <li class="myaccount-login-menu"><?php
                                            if (is_user_logged_in()) {
                                                ?>
                                                <a href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>"><i class="fa fa-lock"></i> <?php _e('My Account', 'somalite'); ?></a>           			
                                                <?php
