var bagPriceCalculator = new Vue({
    ...
    computed: {
        ...
        download_diecut_url: function () {
            ...
            var tw = 0.5 * W + H + 71;
            console.log(tw);
            if ((tl < 736 && tw < 482) || (tl < 482 && tw < 736)) {
                return "http://47.52.24.242/GenFormat/GenSVG/StandardName/DRD008182FrontBuilder01/Palette/All/Length/" + L + "/Width/" + W + "/Depth/" + H;
            }
        }
    }
})